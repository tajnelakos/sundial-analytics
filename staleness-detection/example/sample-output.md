...
Checking [`strategy/competitive-landscape.md`](../../strategy/competitive-landscape.md) against a fictional newer signal — continuing the ValuAI thread from [`battle-card-generator`](../../battle-card-generator/example/sample-output.md).
...
>
> Document to check: strategy/competitive-landscape.md, ValuAI section.

## Output

```
## Staleness Check — strategy/competitive-landscape.md (ValuAI section) — against April 2026 ValuAI release notes
