...
System instructions as configured in ChatGPT's GPT builder. Same logic as the [Claude Skill](../claude-skill/SKILL.md). In production this GPT would have the four `strategy/` reference docs uploaded as knowledge files; the instructions below assume that context is available to the model.
