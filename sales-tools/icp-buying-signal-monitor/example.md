...
Signals scored against [`icp.md`](../../knowledge-base/icp.md). This example's flagged account, Nordkredit, is carried through to [`abm-account-brief`](../abm-account-brief) and [`personalized-outbound`](../../marketing-assets/personalized-outbound).
