...
This is the first step in a small pipeline demonstrated across three use cases: a flagged account here feeds [`abm-account-brief`](../abm-account-brief) (build the full picture) and [`personalized-outbound`](../../marketing-assets/personalized-outbound) (act on it) — see the [Nordkredit example](./example.md) carried through both.
