...
- [`weekly-brief-example.md`](./weekly-brief-example.md) — a weekly brief run against [Sundial Analytics](../../knowledge-base/knowledge-base.md)'s competitors
...
- [`bi-monthly-report-2026-07-08.html`](./bi-monthly-report-2026-07-08.html) — the same report as a designed, one-page HTML version ([view live ↗](https://tajnelakos.github.io/sundial-analytics/sales-tools/competitor-monitoring/bi-monthly-report-2026-07-08.html))
