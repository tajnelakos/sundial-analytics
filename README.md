...
|---|---|---|
| [`competitor-monitoring/`](./competitor-monitoring) | Turns scattered competitor signals into a structured weekly brief, plus a sourced [bi-monthly deep-dive](./competitor-monitoring/bi-monthly-analysis) | Claude Skill, Custom GPT |
