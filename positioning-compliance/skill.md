...
1. **Scan for prohibited terms** from `voice-guide.md` — exact matches and close variants (e.g. "seamlessly" counts as "seamless"). Quote the exact sentence each occurs in.
