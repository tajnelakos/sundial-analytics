...
Same draft used as the "before" in [`brand-voice-guidelines`](../brand-voice-guidelines/before-after.md) — shown here going through the compliance checker instead, which flags rather than fixes.
