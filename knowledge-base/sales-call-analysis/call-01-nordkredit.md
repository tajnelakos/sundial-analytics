...
*Context: Lena responded to an outbound email referencing her recent hire and Nordkredit's tooling migration (see [`personalized-outbound`](../../marketing-assets/personalized-outbound/example.md)).*
