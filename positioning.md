...
Used by prompts/skills that generate customer-facing content — see [`sales-deck-builder`](./sales-deck-builder) and [`brand-voice-guidelines`](./brand-voice-guidelines).
